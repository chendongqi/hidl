...
CIP_PROPERTIES_BUILD_RPOP += ro.vendor.cip.build.date=`date`
ifdef OPTR_SPEC_SEG_DEF
ifneq ($(strip $(OPTR_SPEC_SEG_DEF)),NONE)
ifneq ($(filter-out no,$(strip $(MTK_CARRIEREXPRESS_PACK))),)
CIP_PROPERTIES_BUILD_RPOP += persist.vendor.mtk_usp_md_sbp_code=$(subst OP,,$(OPTR))
endif
CIP_PROPERTIES_BUILD_RPOP += persist.vendor.operator.optr=$(OPTR)
CIP_PROPERTIES_BUILD_RPOP += persist.vendor.operator.spec=$(SPEC)
CIP_PROPERTIES_BUILD_RPOP += persist.vendor.operator.seg=$(SEG)
CIP_PROPERTIES_BUILD_RPOP += ro.vendor.mtk_md_sbp_custom_value=$(patsubst OP%,%,$(OPTR))
endif
endif#OPTR_SPEC_SEG_DEF
ifneq ($(filter-out no,$(strip $(MTK_CARRIEREXPRESS_PACK))),)
CIP_PROPERTIES_BUILD_RPOP += ro.vendor.mtk_carrierexpress_pack=$(strip $(MTK_CARRIEREXPRESS_PACK))
endif
