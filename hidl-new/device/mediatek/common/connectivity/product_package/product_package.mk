...
ifeq ($(BUILD_SOC_V2_0), true)
    PRODUCT_COPY_FILES += $(patch_folder)/soc1_0_patch_mcu_2_1_hdr.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/soc1_0_patch_mcu_2_1_hdr.bin:mtk
    PRODUCT_COPY_FILES += $(patch_folder)/soc1_0_ram_mcu_2_1_hdr.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/soc1_0_ram_mcu_2_1_hdr.bin:mtk
    PRODUCT_COPY_FILES += $(patch_folder)/soc1_0_ram_bt_2_1_hdr.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/soc1_0_ram_bt_2_1_hdr.bin:mtk
endif
...
ifneq ($(TARGET_BUILD_VARIANT),user)
    COREDUMP_MODE := 2
    PRODUCT_SYSTEM_DEFAULT_PROPERTIES += persist.vendor.connsys.coredump.mode=$(COREDUMP_MODE)
endif
