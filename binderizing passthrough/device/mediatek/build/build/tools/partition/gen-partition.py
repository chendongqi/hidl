...
""" % (entry["partition_index"], entry["partition_name"], entry.get("file_name", "NONE") if entry.get("file_name", "NONE") != "tee.img" or os.getenv("MTK_IN_HOUSE_TEE_SUPPORT","yes") == "yes" else "trustzone.bin",
entry.get("is_download", False) and "true" or "false",
entry.get("is_upgradable", False) and "true" or "false",
