...
#define SEC_LOG_TRACE 0
#define SEC_LOG_DEBUG 0
#define SEC_LOG_ERROR 1
#define SEC_LOG_INFO 1
#define SMSG_TRACE(...) do { if(SEC_LOG_TRACE) printf(__VA_ARGS__); } while(0)
#define SMSG_DEBUG(...) do { if(SEC_LOG_DEBUG) printf(__VA_ARGS__); } while(0)
#define SMSG_ERROR(...) do { if(SEC_LOG_ERROR) printf(__VA_ARGS__); } while(0)
#define SMSG_INFO(...) do { if(SEC_LOG_INFO) printf(__VA_ARGS__); } while(0)
